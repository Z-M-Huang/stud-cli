/**
 * Path-scope helpers for the edit reference tool.
 *
 ...
 *
 * This matches the approval-key granularity defined in Q-8: edits to files
 * at the project-root top level share the key `""`, while edits in `src/foo/`
